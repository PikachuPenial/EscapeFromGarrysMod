...
function GM:Initialize()
  ...
  isSellMenu = false
	...
	tempWeaponsArray[29] = {"models/weapons/arccw_go/v_eq_taser.mdl", "arccw_go_taser", "Advanced Taser M26", 3333, "3", "UTIL", "Pistol"}
	tempWeaponsArray[30] = {"models/weapons/arccw_go/v_eq_incendiarygrenade.mdl", "arccw_go_nade_incendiary", "AN/M14 Thermite Grenade", 2500, "3", "UTIL", "Grenade"}
	tempWeaponsArray[31] = {"models/weapons/arccw_go/v_eq_fraggrenade.mdl", "arccw_go_nade_frag", "M67 Frag Grenade", 2500, "3", "UTIL", "Grenade"}
	tempWeaponsArray[32] = {"models/weapons/arccw_go/v_eq_flashbang.mdl", "arccw_go_nade_flash", "M84 Stun Grenade", 2500, "3", "UTIL", "Grenade"}
	tempWeaponsArray[33] = {"models/weapons/arccw_go/v_eq_smokegrenade.mdl", "arccw_go_nade_smoke", "M5210 Smoke Grenade", 2500, "3", "UTIL", "Grenade"}
	tempWeaponsArray[34] = {"models/weapons/arccw_go/v_eq_molotov.mdl", "arccw_go_nade_molotov", "Molotov Cocktail", 2500, "3", "UTIL", "Grenade"}
	tempWeaponsArray[35] = {"models/weapons/arccw_go/v_eq_throwingknife.mdl", "arccw_go_nade_knife", "Throwing Knife", 2500, "3", "UTIL", "Grenade"}
	tempWeaponsArray[36] = {"models/weapons/c_csgo_flashbang.mdl", "weapon_csgo_flashbang", "M84 MK2 Flash Grenade", 2500, "3", "UTIL", "Grenade"}
	tempWeaponsArray[37] = {"models/weapons/arccw_go/v_shot_m1014.mdl", "arccw_go_m1014", "M1014 SG", 11510, "10", "MID", "Shotgun"}
	tempWeaponsArray[38] = {"models/weapons/arccw_go/v_mach_m249para.mdl", "arccw_go_m249para", "M249 SAW LMG", 14000, "12", "HIGH", "Heavy"}
	tempWeaponsArray[39] = {"models/weapons/arccw_go/v_shot_mag7.mdl", "arccw_go_mag7", "MAG-7 SG", 13333, "13", "HIGH", "Shotgun"}
	tempWeaponsArray[40] = {"models/weapons/arccw_go/v_shot_870.mdl", "arccw_go_870", "Model 870 SG", 8905, "8", "LOW", "Shotgun"}
	tempWeaponsArray[41] = {"models/weapons/arccw_go/v_mach_negev.mdl", "arccw_go_negev", "Negev LMG", 12000, "10", "MID", "Heavy"}
	tempWeaponsArray[42] = {"models/weapons/arccw_go/v_shot_nova.mdl", "arccw_go_nova", "Supernova SG", 11250, "10", "MID", "Shotgun"}
	tempWeaponsArray[43] = {"models/weapons/arccw_go/v_pist_cz75.mdl", "arccw_go_cz75", "CZ-75", 4790, "4", "LOW", "Pistol"}
	tempWeaponsArray[44] = {"models/weapons/arccw_go/v_pist_deagle.mdl", "arccw_ur_deagle", "Desert Eagle", 6005, "5", "LOW", "Pistol"}
	tempWeaponsArray[45] = {"models/weapons/arccw_go/v_pist_fiveseven.mdl", "arccw_go_fiveseven", "Five-seveN", 4250, "3", "LOW", "Pistol"}
	tempWeaponsArray[46] = {"models/weapons/arccw_go/v_pist_glock.mdl", "arccw_go_glock", "Glock 17", 4700, "4", "LOW", "Pistol"}
	tempWeaponsArray[47] = {"models/weapons/arccw_go/v_pist_m9.mdl", "arccw_go_m9", "M92FS", 4250, "3", "LOW", "Pistol"}
	tempWeaponsArray[48] = {"models/weapons/arccw_go/v_pist_r8.mdl", "arccw_go_r8", "Model 327 R8", 6005, "5", "LOW", "Pistol"}
	tempWeaponsArray[49] = {"models/weapons/arccw_go/v_pist_p2000.mdl", "arccw_go_p2000", "P2000", 4250, "3", "LOW", "Pistol"}
	tempWeaponsArray[50] = {"models/weapons/arccw_go/v_pist_p250.mdl", "arccw_go_p250", "P250", 4700, "4", "LOW", "Pistol"}
	tempWeaponsArray[51] = {"models/weapons/arccw_go/v_pist_sw29.mdl", "arccw_go_sw29", "S&W M29", 5250, "4", "LOW", "Pistol"}
	tempWeaponsArray[52] = {"models/weapons/arccw_go/v_pist_tec9.mdl", "arccw_go_tec9", "TEC-9", 5250, "4", "LOW", "Pistol"}
	tempWeaponsArray[53] = {"models/weapons/arccw_go/v_pist_usp.mdl", "arccw_go_usp", "USP-45", 4700, "4", "LOW", "Pistol"}
	tempWeaponsArray[54] = {"models/weapons/arccw_go/v_rif_ace.mdl", "arccw_go_ace", "ACE 23", 15920, "11", "HIGH", "Rifle"}
	tempWeaponsArray[55] = {"models/weapons/arccw_go/v_rif_ak47.mdl", "arccw_go_ak47", "AKM", 13905, "10", "MID", "Rifle"}
	tempWeaponsArray[56] = {"models/weapons/arccw_go/v_rif_car15.mdl", "arccw_go_ar15", "AR-15", 11995, "8", "MID", "Rifle"}
	tempWeaponsArray[57] = {"models/weapons/arccw_go/v_rif_aug.mdl", "arccw_go_aug", "AUG A3", 14250, "12", "MID", "Rifle"}
	tempWeaponsArray[58] = {"models/weapons/arccw_go/v_snip_awp.mdl", "arccw_go_awp", "AWSM SR", 17995, "16", "HIGH", "Sniper"}
	tempWeaponsArray[59] = {"models/weapons/arccw_go/v_rif_fnfal.mdl", "arccw_go_fnfal", "FAL", 17250, "14", "HIGH", "Rifle"}
	tempWeaponsArray[60] = {"models/weapons/arccw_go/v_rif_famas.mdl", "arccw_go_famas", "FAMAS G1", 13995, "11", "MID", "Rifle"}
	tempWeaponsArray[61] = {"models/weapons/arccw_go/v_rif_g3.mdl", "arccw_go_g3", "G3", 18500, "16", "HIGH", "Rifle"}
	tempWeaponsArray[62] = {"models/weapons/arccw_go/v_rif_galil_ar.mdl", "arccw_go_galil_ar", "Galil AR", 18500, "16", "HIGH", "Rifle"}
	tempWeaponsArray[63] = {"models/weapons/arccw_go/v_rif_car15.mdl", "arccw_go_m16a2", "M16A2", 16550, "14", "MID", "Rifle"}
	tempWeaponsArray[64] = {"models/weapons/arccw_go/v_rif_m4a1.mdl", "arccw_go_m4", "M4A1", 17110, "14", "HIGH", "Rifle"}
	tempWeaponsArray[65] = {"models/weapons/arccw_go/v_rif_scar.mdl", "arccw_go_scar", "SCAR-T", 17600, "15", "HIGH", "Rifle"}
	tempWeaponsArray[66] = {"models/weapons/arccw_go/v_rif_sg556.mdl", "arccw_go_sg556", "SIG SG556", 16640, "13", "HIGH", "Rifle"}
	tempWeaponsArray[67] = {"models/weapons/arccw_go/v_snip_ssg08.mdl", "arccw_go_ssg08", "SSG08 SR", 15625, "13", "MID", "Sniper"}
	tempWeaponsArray[68] = {"models/weapons/arccw_go/v_smg_mac10.mdl", "arccw_go_mac10", "MAC-10", 7600, "6", "LOW", "SMG"}
	tempWeaponsArray[69] = {"models/weapons/arccw_go/v_smg_mp5.mdl", "arccw_go_mp5", "MP5A2", 8240, "7", "LOW", "SMG"}
	tempWeaponsArray[70] = {"models/weapons/arccw_go/v_smg_mp7.mdl", "arccw_go_mp7", "MP7A2", 8590, "7", "LOW", "SMG"}
	tempWeaponsArray[71] = {"models/weapons/arccw_go/v_smg_mp9.mdl", "arccw_go_mp9", "MP9N", 8590, "8", "LOW", "SMG"}
	tempWeaponsArray[72] = {"models/weapons/arccw_go/v_smg_p90.mdl", "arccw_go_p90", "P90 TR", 14990, "10", "MID", "SMG"}
	tempWeaponsArray[73] = {"models/weapons/arccw_go/v_smg_bizon.mdl", "arccw_go_bizon", "PP-19 Bizon-2", 8750, "8", "MID", "SMG"}
	tempWeaponsArray[74] = {"models/weapons/arccw_go/v_smg_ump45.mdl", "arccw_go_ump", "UMP-9mm", 9360, "9", "LOW", "SMG"}
	tempWeaponsArray[75] = {"models/weapons/arccw/c_xm8.mdl", "midnights_gso_xm8", "HK XM8", 18920, "17", "HIGH", "Rifle"}
	tempWeaponsArray[76] = {"models/weapons/arccw/midnightwolf/type20.mdl", "arccw_midnightwolf_type20", "Type 20", 17880, "15", "HIGH", "Rifle"}
	tempWeaponsArray[77] = {"models/viper/mw/weapons/w_725_mammaledition.mdl", "arccw_725", "Citori 725 SG", 8950, "7", "LOW", "Shotgun"}
	tempWeaponsArray[78] = {"models/weapons/cod_mw2019/w_g36k_mammaledition.mdl", "arccw_g36mw19", "G36K", 14445, "13", "MID", "Rifle"}
	tempWeaponsArray[79] = {"models/viper/mw/weapons/kilo433_mammaledition.mdl", "arccw_kilo141", "HK433", 15690, "14", "MID", "Rifle"}
	tempWeaponsArray[80] = {"models/weapons/arccw/fml/mw19/w_mk2_k.mdl", "arccw_fml_mk2k", "MK2-K DMR", 11050, "8", "MID", "Rifle"}
	tempWeaponsArray[81] = {"models/weapons/cod_mw2019/c_sg552_mammaledition.mdl", "arccw_grau", "SG 552 Commando", 13005, "13", "MID", "Rifle"}
	tempWeaponsArray[82] = {"models/weapons/arccw/c_ud_glock.mdl", "arccw_ud_glock", "Glock 22", 6005, "5", "LOW", "Pistol"}
	tempWeaponsArray[83] = {"models/weapons/arccw/c_ud_m16.mdl", "arccw_ud_m16", "M16A3", 16995, "14", "MID", "Rifle"}
	tempWeaponsArray[84] = {"models/weapons/arccw/c_ud_m1014.mdl", "arccw_ud_m1014", "M4 Super 90 SG", 12995, "12", "MID", "Shotgun"}
	tempWeaponsArray[85] = {"models/weapons/arccw/c_ud_m79.mdl", "arccw_ud_m79", "M79 Grenade Launcher", 22555, "20", "HIGH", "Heavy"}
	tempWeaponsArray[86] = {"models/weapons/arccw/c_ud_mini14.mdl", "arccw_ud_mini14", "Mini-14", 16420, "14", "MID", "Rifle"}
	tempWeaponsArray[87] = {"models/weapons/arccw/c_ud_870.mdl", "arccw_ud_870", "Remington 870", 10240, "9", "MID", "Shotgun"}
	tempWeaponsArray[88] = {"models/weapons/arccw/c_ud_uzi.mdl", "arccw_ud_uzi", "Uzi", 11040, "8", "LOW", "SMG"}
	tempWeaponsArray[89] = {"models/weapons/arccw/w_arccw_smg0818.mdl", "arccw_ww1_smg0818", "Maxim SMG LMG", 27500, "22", "HIGH", "Heavy"}
	tempWeaponsArray[90] = {"models/weapons/arccw/mifl/fas2/c_ak47.mdl", "arccw_mifl_fas2_ak47", "AKM", 17005, "15", "HIGH", "Rifle"}
	tempWeaponsArray[91] = {"models/weapons/arccw/mifl/fas2/c_famas.mdl", "arccw_mifl_fas2_famas", "FAMAS", 16990, "14", "MID", "Rifle"}
	tempWeaponsArray[92] = {"models/weapons/arccw/mifl/fas2/c_g3.mdl", "arccw_mifl_fas2_g3", "G3A3", 16310, "14", "MID", "Rifle"}
	tempWeaponsArray[93] = {"models/weapons/arccw/mifl/fas2/c_ks23.mdl", "arccw_mifl_fas2_ks23", "KS-23", 13005, "13", "MID", "Shotgun"}
	tempWeaponsArray[94] = {"models/weapons/arccw/mifl/fas2/c_m24.mdl", "arccw_mifl_fas2_m24", "M24 SR", 18900, "15", "HIGH", "Sniper"}
	tempWeaponsArray[95] = {"models/weapons/arccw/mifl/fas2/c_m3s90.mdl", "arccw_mifl_fas2_m3", "M3 Super 90", 14505, "14", "MID", "Shotgun"}
	tempWeaponsArray[96] = {"models/weapons/arccw/mifl/fas2/c_m82.mdl", "arccw_mifl_fas2_m82", "M82 SR", 20999, "20", "HIGH", "Sniper"}
	tempWeaponsArray[97] = {"models/weapons/arccw/mifl/fas2/c_mac11.mdl", "arccw_mifl_fas2_mac11", "MAC-11", 8100, "6", "LOW", "SMG"}
	tempWeaponsArray[98] = {"models/weapons/arccw/mifl/fas2_custom/c_m26.mdl", "arccw_fml_fas2_custom_mass26", "MASS-26 SG", 14895, "15", "HIGH", "Shotgun"}
	tempWeaponsArray[99] = {"models/weapons/arccw/mifl/fas2/c_minimi.mdl", "arccw_mifl_fas2_minimi", "Minimi", 19995, "20", "HIGH", "Heavy"}
	tempWeaponsArray[100] = {"models/weapons/arccw/mifl/fas2/c_ragingbull.mdl", "arccw_mifl_fas2_ragingbull", "Raging Bull Revolver", 7020, "7", "LOW", "Pistol"}
	tempWeaponsArray[101] = {"models/weapons/arccw/mifl/fas2/c_rpk.mdl", "arccw_mifl_fas2_rpk", "RPK47", 14765, "14", "MID", "Heavy"}
	tempWeaponsArray[102] = {"models/weapons/arccw/mifl/fas2/c_sg552.mdl", "arccw_mifl_fas2_sg55x", "SG552", 15490, "14", "MID", "Rifle"}
	tempWeaponsArray[103] = {"models/weapons/arccw/mifl/fas2/c_sr25.mdl", "arccw_mifl_fas2_sr25", "SR-25", 17420, "16", "HIGH", "Rifle"}
	tempWeaponsArray[104] = {"models/weapons/arccw/mifl/fas2/c_toz34.mdl", "arccw_mifl_fas2_toz34", "TOZ-34", 12690, "12", "LOW", "Shotgun"}
	tempWeaponsArray[105] = {"models/weapons/arccw/c_claymorelungemine.mdl", "arccw_claymorelungemine", "Claymore Lunge Mine", 5555, "5", "UTIL", "Heavy"}
	tempWeaponsArray[106] = {"models/weapons/arc_eft_usp/c_eft_usp.mdl", "arccw_eft_usp", "HK USP .45", 5555, "5", "LOW", "Pistol"}
	tempWeaponsArray[107] = {"models/weapons/arccw/darsu_eft/c_mp153.mdl", "arccw_eft_mp153", "MP-153", 15005, "13", "MID", "Shotgun"}
	tempWeaponsArray[108] = {"models/weapons/arccw/darsu_eft/c_mp153.mdl", "arccw_eft_mp155", "MP-155", 14005, "12", "MID", "Shotgun"}
	tempWeaponsArray[109] = {"models/weapons/arc_eft_scarl/c_eft_scarh.mdl", "arccw_eft_scarh", "SCAR-H", 17090, "15", "HIGH", "Rifle"}
	tempWeaponsArray[110] = {"models/weapons/arc_eft_scarl/c_eft_scarl.mdl", "arccw_eft_scarl", "SCAR-L", 15995, "14", "MID", "Rifle"}
	tempWeaponsArray[111] = {"models/weapons/arccw/fml/w_fo12_mw.mdl", "arccw_fml_mw_fo12", "FO-12 Shotgun", 20999, "18", "HIGH", "Shotgun"}
	tempWeaponsArray[112] = {"models/weapons/cod_mw2019/w_oden_mammaledition.mdl", "arccw_oden", "VLK Oden", 18505, "16", "MID", "Rifle"}
	tempWeaponsArray[113] = {"models/weapons/arccw_go/v_smg_mp5.mdl", "arccw_ur_mp5", "MP5A4", 10005, "8", "LOW", "SMG"}
	tempWeaponsArray[114] = {"models/weapons/arccw_go/v_snip_awp.mdl", "arccw_ur_aw", "AWM SR", 13095, "12", "MID", "Sniper"}
