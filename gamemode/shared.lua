...
function GM:Initialize()
	...
	tempWeaponsArray[2] = {"models/weapons/arccw/dm1973/w_arccw_dmi_c7a2.mdl", "arccw_dmi_c7a2_inftry", "C7A2", 16955, "10", "HIGH", "Rifle"}
	tempWeaponsArray[3] = {"models/weapons/arccw/w_zz_mg24_tp.mdl", "arccw_dp28", "DP-28 HLMG", 21370, "14", "HIGH", "Heavy"}
	tempWeaponsArray[4] = {"models/weapons/arc_eft_aks74u/eft_aks74u/models/c_eft_aks74u.mdl", "arccw_eft_aks74u", "AKS-74u", 9980, "5", "LOW", "SMG"}
	tempWeaponsArray[5] = {"models/weapons/arc_eft_1911/c_eft_1911/models/c_eft_1911.mdl", "arccw_eft_1911", "M1911", 4140, "1", "LOW", "Pistol"}
	tempWeaponsArray[6] = {"models/weapons/arc_eft_mp5/w_eft_mp5/models/w_eft_mp5.mdl", "arccw_eft_mp5", "MP5", 10995, "6", "LOW", "SMG"}
	tempWeaponsArray[7] = {"models/weapons/arc_eft_mp5/w_eft_mp5_std/models/w_eft_mp5_std.mdl", "arccw_eft_mp5sd", "MP5SD", 9995, "5", "LOW", "SMG"}
	tempWeaponsArray[8] = {"models/weapons/arc_eft_mp7/eft_mp7/models/c_eft_mp7.mdl", "arccw_eft_mp7", "MP7A1", 13195, "7", "MID", "SMG"}
	tempWeaponsArray[9] = {"models/weapons/arc_eft_ppsh/c_eft_ppsh/models/c_eft_ppsh.mdl", "arccw_eft_ppsh", "PPSH-41", 8440, "5", "LOW", "SMG"}
	tempWeaponsArray[10] = {"models/weapons/arc_eft_t5000/eft_t5000/models/c_eft_t5000.mdl", "arccw_eft_t5000", "T-5000", 18050, "12", "HIGH", "Sniper"}
	tempWeaponsArray[11] = {"models/weapons/arc_eft_ump/eft_ump/models/c_eft_ump.mdl", "arccw_eft_ump", "UMP-45", 10050, "6", "LOW", "SMG"}
	tempWeaponsArray[12] = {"models/weapons/arccw/eap/c_aek971.mdl", "arccw_eap_aek", "AEK-971", 17120, "11", "HIGH", "Rifle"}
	tempWeaponsArray[13] = {"models/weapons/arccw/eap/c_brenten.mdl", "arccw_eap_brenten", "Bren Ten Pistol", 6010, "2", "LOW", "Pistol"}
	tempWeaponsArray[14] = {"models/weapons/arccw/eap/c_csls5.mdl", "arccw_eap_csls5", "CS/LS5 SMG", 10510, "6", "MID", "SMG"}
	tempWeaponsArray[15] = {"models/weapons/arccw/eap/c_fmg9.mdl", "arccw_eap_fmg9", "FMG-9", 15555, "10", "MID", "SMG"}
	tempWeaponsArray[16] = {"models/weapons/arccw/eap/c_groza.mdl", "arccw_eap_groza", "OTs-14 Groza", 13580, "10", "MID", "Rifle"}
	tempWeaponsArray[17] = {"models/weapons/arccw/eap/c_lebedev.mdl", "arccw_eap_lebedev", "PL-15 Lebedev Pistol", 4630, "1", "LOW", "Pistol"}
	tempWeaponsArray[18] = {"models/weapons/arccw/eap/c_spectre.mdl", "arccw_eap_spectre", "Spectre M4", 11010, "7", "MID", "SMG"}
	tempWeaponsArray[19] = {"models/weapons/arccw/eap/c_stg44.mdl", "arccw_eap_stg44", "StG-44", 13100, "9", "MID", "Rifle"}
	tempWeaponsArray[20] = {"models/weapons/arccw/eap/c_usas.mdl", "arccw_eap_usas", "USAS-12", 27510, "16", "HIGH", "Shotgun"}
	tempWeaponsArray[21] = {"models/weapons/arccw/eap/c_vp70.mdl", "arccw_eap_vp70", "VP70", 5005, "2", "LOW", "Pistol"}
	tempWeaponsArray[22] = {"models/weapons/arccw/eap/c_xm29.mdl", "arccw_eap_xm29", "XM29", 18005, "12", "HIGH", "Rifle"}
	tempWeaponsArray[23] = {"models/weapons/arccw/slogkot/c_altor.mdl", "arccw_slog_altor", "Altor Pistol", 5005, "2", "LOW", "Pistol"}
	tempWeaponsArray[24] = {"models/weapons/arccw/fml/w_fatcry5_arc.mdl", "arccw_fml_blast_fc5_arc", "AR-C", 15005, "12", "HIGH", "Rifle"}
	tempWeaponsArray[25] = {"models/weapons/arccw/kriss/w_kriss.mdl", "arccw_krissvector", "Kriss Vector", 20005, "14", "HIGH", "SMG"}
	tempWeaponsArray[26] = {"models/weapons/c_tderp_asval2.mdl", "arccw_asval", "AS VAL", 17990, "12", "HIGH", "Rifle"}
	tempWeaponsArray[27] = {"models/weapons/arccw/mifl/sketchfab/c_msd9.mdl", "arccw_mifl_mds9", "MDS-9", 6200, "3", "LOW", "Pistol"}
	tempWeaponsArray[28] = {"models/weapons/w_rif_pindadss2.mdl", "arccw_blast_pindadss2", "Pindad SS2-V1", 18200, "11", "HIGH", "Rifle"}
	tempWeaponsArray[29] = {"models/weapons/arccw_go/v_eq_incendiarygrenade.mdl", "arccw_go_nade_incendiary", "AN/M14 Thermite Grenade", 2500, "2", "UTIL", "Grenade"}
	tempWeaponsArray[30] = {"models/weapons/arccw_go/v_eq_fraggrenade.mdl", "arccw_go_nade_frag", "M67 Frag Grenade", 2500, "2", "UTIL", "Grenade"}
	tempWeaponsArray[31] = {"models/weapons/arccw_go/v_eq_flashbang.mdl", "arccw_go_nade_flash", "M84 Stun Grenade", 2500, "2", "UTIL", "Grenade"}
	tempWeaponsArray[32] = {"models/weapons/arccw_go/v_eq_smokegrenade.mdl", "arccw_go_nade_smoke", "M5210 Smoke Grenade", 2500, "2", "UTIL", "Grenade"}
	tempWeaponsArray[33] = {"models/weapons/arccw_go/v_eq_molotov.mdl", "arccw_go_nade_molotov", "Molotov Cocktail", 2500, "2", "UTIL", "Grenade"}
	tempWeaponsArray[34] = {"models/weapons/arccw_go/v_eq_throwingknife.mdl", "arccw_go_nade_knife", "Throwing Knife", 2500, "2", "UTIL", "Grenade"}
	tempWeaponsArray[35] = {"models/weapons/c_csgo_flashbang.mdl", "weapon_csgo_flashbang", "M84 MK2 Flash Grenade", 2500, "2", "UTIL", "Grenade"}
	tempWeaponsArray[36] = {"models/weapons/arccw_go/v_pist_deagle.mdl", "arccw_ur_deagle", "Desert Eagle", 6005, "4", "LOW", "Pistol"}
	tempWeaponsArray[37] = {"models/weapons/arccw/c_xm8.mdl", "midnights_gso_xm8", "HK XM8", 18920, "14", "HIGH", "Rifle"}
	tempWeaponsArray[38] = {"models/weapons/arccw/midnightwolf/type20.mdl", "arccw_midnightwolf_type20", "Type 20", 17880, "13", "HIGH", "-=Rifle"}
	tempWeaponsArray[39] = {"models/viper/mw/weapons/w_725_mammaledition.mdl", "arccw_725", "Citori 725 SG", 8950, "4", "LOW", "Shotgun"}
	tempWeaponsArray[40] = {"models/weapons/cod_mw2019/w_g36k_mammaledition.mdl", "arccw_g36mw19", "G36K", 14445, "11", "MID", "Rifle"}
	tempWeaponsArray[41] = {"models/viper/mw/weapons/kilo433_mammaledition.mdl", "arccw_kilo141", "HK433", 15690, "12", "MID", "Rifle"}
	tempWeaponsArray[42] = {"models/weapons/arccw/fml/mw19/w_mk2_k.mdl", "arccw_fml_mk2k", "MK2-K DMR", 11050, "8", "MID", "Rifle"}
	tempWeaponsArray[43] = {"models/weapons/cod_mw2019/c_sg552_mammaledition.mdl", "arccw_grau", "SG 552 Commando", 13005, "10", "MID", "Rifle"}
	tempWeaponsArray[44] = {"models/weapons/arccw/c_ud_glock.mdl", "arccw_ud_glock", "Glock 22", 6005, "3", "LOW", "Pistol"}
	tempWeaponsArray[45] = {"models/weapons/arccw/c_ud_m16.mdl", "arccw_ud_m16", "M16A3", 16995, "12", "MID", "Rifle"}
	tempWeaponsArray[46] = {"models/weapons/arccw/c_ud_m1014.mdl", "arccw_ud_m1014", "M4 Super 90 SG", 12995, "8", "MID", "Shotgun"}
	tempWeaponsArray[47] = {"models/weapons/arccw/c_ud_m79.mdl", "arccw_ud_m79", "M79 Grenade Launcher", 22555, "18", "HIGH", "Heavy"}
	tempWeaponsArray[48] = {"models/weapons/arccw/c_ud_mini14.mdl", "arccw_ud_mini14", "Mini-14", 16420, "12", "MID", "Rifle"}
	tempWeaponsArray[49] = {"models/weapons/arccw/c_ud_870.mdl", "arccw_ud_870", "Remington 870", 10240, "6", "MID", "Shotgun"}
	tempWeaponsArray[50] = {"models/weapons/arccw/c_ud_uzi.mdl", "arccw_ud_uzi", "Uzi", 11040, "6", "LOW", "SMG"}
	tempWeaponsArray[51] = {"models/weapons/arccw/w_arccw_smg0818.mdl", "arccw_ww1_smg0818", "Maxim SMG LMG", 27500, "20", "HIGH", "Heavy"}
	tempWeaponsArray[52] = {"models/weapons/arccw/mifl/fas2/c_ak47.mdl", "arccw_mifl_fas2_ak47", "AKM", 17005, "13", "HIGH", "Rifle"}
	tempWeaponsArray[53] = {"models/weapons/arccw/mifl/fas2/c_famas.mdl", "arccw_mifl_fas2_famas", "FAMAS", 16990, "12", "MID", "Rifle"}
	tempWeaponsArray[54] = {"models/weapons/arccw/mifl/fas2/c_g3.mdl", "arccw_mifl_fas2_g3", "G3A3", 16310, "12", "MID", "Rifle"}
	tempWeaponsArray[55] = {"models/weapons/arccw/mifl/fas2/c_ks23.mdl", "arccw_mifl_fas2_ks23", "KS-23", 13005, "8", "MID", "Shotgun"}
	tempWeaponsArray[56] = {"models/weapons/arccw/mifl/fas2/c_m24.mdl", "arccw_mifl_fas2_m24", "M24 SR", 18900, "14", "HIGH", "Sniper"}
	tempWeaponsArray[57] = {"models/weapons/arccw/mifl/fas2/c_m3s90.mdl", "arccw_mifl_fas2_m3", "M3 Super 90", 14505, "12", "MID", "Shotgun"}
	tempWeaponsArray[58] = {"models/weapons/arccw/mifl/fas2/c_m82.mdl", "arccw_mifl_fas2_m82", "M82 SR", 20999, "18", "HIGH", "Sniper"}
	tempWeaponsArray[59] = {"models/weapons/arccw/mifl/fas2/c_mac11.mdl", "arccw_mifl_fas2_mac11", "MAC-11", 8100, "5", "LOW", "SMG"}
	tempWeaponsArray[60] = {"models/weapons/arccw/mifl/fas2_custom/c_m26.mdl", "arccw_fml_fas2_custom_mass26", "MASS-26 SG", 17550, "14", "HIGH", "Shotgun"}
	tempWeaponsArray[61] = {"models/weapons/arccw/mifl/fas2/c_minimi.mdl", "arccw_mifl_fas2_minimi", "Minimi", 19995, "16", "HIGH", "Heavy"}
	tempWeaponsArray[62] = {"models/weapons/arccw/mifl/fas2/c_ragingbull.mdl", "arccw_mifl_fas2_ragingbull", "Raging Bull Revolver", 7020, "4", "LOW", "Pistol"}
	tempWeaponsArray[63] = {"models/weapons/arccw/mifl/fas2/c_rpk.mdl", "arccw_mifl_fas2_rpk", "RPK47", 14765, "10", "MID", "Heavy"}
	tempWeaponsArray[64] = {"models/weapons/arccw/mifl/fas2/c_sg552.mdl", "arccw_mifl_fas2_sg55x", "SG552", 15490, "12", "MID", "Rifle"}
	tempWeaponsArray[65] = {"models/weapons/arccw/mifl/fas2/c_sr25.mdl", "arccw_mifl_fas2_sr25", "SR-25", 17420, "13", "HIGH", "Rifle"}
	tempWeaponsArray[66] = {"models/weapons/arccw/mifl/fas2/c_toz34.mdl", "arccw_mifl_fas2_toz34", "TOZ-34", 12690, "9", "LOW", "Shotgun"}
	...
	tempWeaponsArray[68] = {"models/weapons/arc_eft_usp/c_eft_usp.mdl", "arccw_eft_usp", "HK USP .45", 5555, "3", "LOW", "Pistol"}
	tempWeaponsArray[69] = {"models/weapons/arccw/darsu_eft/c_mp153.mdl", "arccw_eft_mp153", "MP-153", 15005, "10", "MID", "Shotgun"}
	tempWeaponsArray[70] = {"models/weapons/arccw/darsu_eft/c_mp153.mdl", "arccw_eft_mp155", "MP-155", 14005, "10", "MID", "Shotgun"}
	tempWeaponsArray[71] = {"models/weapons/arc_eft_scarl/c_eft_scarh.mdl", "arccw_eft_scarh", "SCAR-H", 17090, "13", "HIGH", "Rifle"}
	tempWeaponsArray[72] = {"models/weapons/arc_eft_scarl/c_eft_scarl.mdl", "arccw_eft_scarl", "SCAR-L", 15995, "12", "MID", "Rifle"}
	tempWeaponsArray[73] = {"models/weapons/arccw/fml/w_fo12_mw.mdl", "arccw_fml_mw_fo12", "FO-12 Shotgun", 20999, "15", "HIGH", "Shotgun"}
	tempWeaponsArray[74] = {"models/weapons/cod_mw2019/w_oden_mammaledition.mdl", "arccw_oden", "VLK Oden", 18505, "14", "HIGH", "Rifle"}
	tempWeaponsArray[75] = {"models/weapons/arccw_go/v_smg_mp5.mdl", "arccw_ur_mp5", "MP5A4", 10005, "5", "LOW", "SMG"}
	tempWeaponsArray[76] = {"models/weapons/arccw_go/v_snip_awp.mdl", "arccw_ur_aw", "AWM SR", 13095, "9", "MID", "Sniper"}
	tempWeaponsArray[77] = {"models/weapons/arccw_sov/v_tkb011.mdl", "arccw_sov_tkb011", "TKB-011", 16000, "12", "HIGH", "Rifle"}
	tempWeaponsArray[78] = {"models/weapons/arccw/c_type89.mdl", "midnights_gso_type89", "Howa Type 89", 18005, "14", "HIGH", "Rifle"}
	tempWeaponsArray[79] = {"models/weapons/bordelzio/arccw/sviinfinity/wmodel/w_svi_infinity.mdl", "arccwsviinfinite", "SVI Infinity", 5555, "3", "LOW", "Pistol"}
	tempWeaponsArray[80] = {"models/weapons/arccw/c_waw_thompson.mdl", "arccw_waw_thompson", "M1A1 Thompson", 11565, "7", "MID", "SMG"}
	tempWeaponsArray[81] = {"models/weapons/arccw/c_waw_mp40.mdl", "arccw_waw_mp40", "MP40", 9895, "6", "LOW", "SMG"}
	tempWeaponsArray[82] = {"models/weapons/arccw/c_waw_type100.mdl", "arccw_waw_type100", "Type 100/44", 12995, "8", "MID", "SMG"}
	tempWeaponsArray[83] = {"models/weapons/arccw/c_bo1_mpl.mdl", "arccw_bo1_mpl", "MPL", 9205, "6", "LOW", "SMG"}
	tempWeaponsArray[84] = {"models/weapons/arccw/c_bo1_pm63.mdl", "arccw_bo1_pm63", "PM-63 RAK", 8995, "5", "LOW", "Pistol"}
	tempWeaponsArray[85] = {"models/weapons/arccw/c_bo1_g11.mdl", "arccw_bo1_g11", "HK G11", 15900, "11", "MID", "Rifle"}
	tempWeaponsArray[86] = {"models/weapons/arccw/c_bo1_law.mdl", "arccw_bo1_law", "M72 LAW RL", 33333, "20", "HIGH", "Heavy"}
	tempWeaponsArray[87] = {"models/weapons/arccw/mifl/fas2/c_glock20.mdl", "arccw_mifl_fas2_g20", "Glock 20", 4700, "2", "LOW", "Pistol"}
	tempWeaponsArray[88] = {"models/weapons/arccw/mifl/fas2/c_p226.mdl", "arccw_mifl_fas2_p226", "P226", 4700, "2", "LOW", "Pistol"}
	tempWeaponsArray[89] = {"models/weapons/arccw/c_waw_nambu.mdl", "arccw_waw_nambu", "Type 14 Nambu", 4250, "1", "LOW", "Pistol"}
	tempWeaponsArray[90] = {"models/weapons/arccw/c_bo1_aug.mdl", "arccw_bo1_aug", "AUG", 14250, "10", "MID", "Rifle"}
	tempWeaponsArray[91] = {"models/weapons/arccw/c_bo1_xl60.mdl", "arccw_bo1_xl60", "XL64ES", 13905, "10", "MID", "Rifle"}
	tempWeaponsArray[92] = {"models/weapons/arccw/c_bo1_famas.mdl", "arccw_bo1_famas", "FAMAS Valorise", 14505, "10", "MID", "Rifle"}
	tempWeaponsArray[93] = {"models/weapons/arccw/c_bo1_fal.mdl", "arccw_bo1_fal", "FN Fal", 17050, "12", "HIGH", "Rifle"}
	tempWeaponsArray[94] = {"models/weapons/arccw/c_bo1_hk21.mdl", "arccw_bo1_hk21", "HK21", 26000, "16", "HIGH", "Heavy"}
	tempWeaponsArray[95] = {"models/weapons/arccw/c_bo1_galil.mdl", "arccw_bo1_galil", "IMI Galil", 14005, "11", "MID", "Rifle"}
	tempWeaponsArray[96] = {"models/weapons/arccw/c_bo1_spas12.mdl", "arccw_bo1_spas12", "SPAS-12", 16000, "13", "MID", "Shotgun"}
	tempWeaponsArray[97] = {"models/weapons/arccw/c_cde_ak5.mdl", "arccw_cde_ak5", "Ak-5", 14940, "12", "MID", "Rifle"}
	tempWeaponsArray[98] = {"models/weapons/arccw/c_waw_mosin.mdl", "arccw_waw_mosin", "Mosin-Nagant M38", 15000, "10", "MID", "Sniper"}
	tempWeaponsArray[99] = {"models/weapons/arccw/c_waw_garand.mdl", "arccw_waw_garand", "M1 Garand", 15500, "11", "MID", "Rifle"}
	tempWeaponsArray[100] = {"models/weapons/arccw/c_waw_357.mdl", "arccw_waw_357", "S&W Model 27", 6995, "3", "LOW", "Pistol"}
	tempWeaponsArray[101] = {"models/weapons/arccw/c_waw_ptrs41.mdl", "arccw_waw_ptrs41", "PTRS-41 SR", 45999, "24", "HIGH", "Sniper"}
	tempWeaponsArray[102] = {"models/weapons/arccw/c_waw_tt33.mdl", "arccw_waw_tt33", "TT-33", 4500, "1", "LOW", "Pistol"}
	tempWeaponsArray[103] = {"models/weapons/arccw/c_bo1_sten.mdl", "arccw_bo1_sten", "Sten Mk II", 11000, "8", "MID", "SMG"}
	tempWeaponsArray[104] = {"models/weapons/arccw/c_waw_fg42.mdl", "arccw_waw_fg42", "FG 42", 40999, "22", "HIGH", "Heavy"}
	tempWeaponsArray[105] = {"models/weapons/arccw/c_bo1_m60.mdl", "arccw_bo1_m60", "M60E3", 32999, "20", "HIGH", "Heavy"}
	tempWeaponsArray[106] = {"models/weapons/arccw/c_waw_trenchgun.mdl", "arccw_waw_trenchgun", "M1897 Trenchgun", 14995, "11", "MID", "Shotgun"}
	tempWeaponsArray[107] = {"models/weapons/arccw/c_bo1_stoner.mdl", "arccw_bo1_stoner", "Stoner 63", 15400, "12", "MID", "Rifle"}
	tempWeaponsArray[108] = {"models/weapons/arccw/c_bo2_fiveseven.mdl", "arccw_bo2_fiveseven", "FN Five-SeveN", 4750, "2", "LOW", "Pistol"}
	tempWeaponsArray[109] = {"models/weapons/arccw/c_cde_m92.mdl", "arccw_cde_m93r", "Beretta 92", 5000, "3", "LOW", "Pistol"}
	tempWeaponsArray[110] = {"models/weapons/arccw/c_waw_mg42.mdl", "arccw_waw_mg42", "MG-42", 52500, "26", "HIGH", "Heavy"}
	tempWeaponsArray[111] = {"models/weapons/arccw/c_bo1_kiparis.mdl", "arccw_bo1_kiparis", "OTS-12 Kiparis", 9550, "4", "LOW", "Pistol"}
	tempWeaponsArray[112] = {"models/weapons/arccw/c_bo1_skorpion.mdl", "arccw_bo1_skorpion", "Skorpion Vz. 65", 9250, "4", "LOW", "Pistol"}
	tempWeaponsArray[113] = {"models/weapons/arccw/c_bo2_vector.mdl", "arccw_bo2_vector", "TDI Kriss Vector 9mm", 24000, "18", "HIGH", "SMG"}
	tempWeaponsArray[114] = {"models/weapons/arccw/c_bo1_svd.mdl", "arccw_bo1_dragunov", "Dragunov SVD", 25000, "18", "HIGH", "Sniper"}
	tempWeaponsArray[115] = {"models/weapons/arccw/c_bo1_rpk.mdl", "arccw_bo1_rpk", "RPK-74", 19500, "15", "HIGH", "Heavy"}
	tempWeaponsArray[116] = {"models/weapons/arccw/c_bo2_lsat.mdl", "arccw_bo2_lsat", "AAI LSAT LMG", 15005, "13", "MID", "Heavy"}
	tempWeaponsArray[117] = {"models/weapons/arccw/c_bo2_smr.mdl", "arccw_bo2_smr", "SMI Saritch .308", 26500, "18", "HIGH", "Rifle"}
	tempWeaponsArray[118] = {"models/weapons/arccw/c_mw2e_f2000.mdl", "arccw_mw2e_f2000", "FN F2000", 16900, "14", "MID", "Rifle"}
	tempWeaponsArray[119] = {"models/weapons/arccw/c_mw3e_rsass.mdl", "arccw_mw3e_rsass", "RSASS", 22255, "17", "HIGH", "Rifle"}
	tempWeaponsArray[120] = {"models/weapons/arccw/c_mw3e_p90.mdl", "arccw_mw3e_p90", "FN P90", 14900, "11", "MID", "SMG"}
	...
	tempWeaponsArray[123] = {"models/weapons/arccw/c_mw3e_mk46.mdl", "arccw_mw3e_mk46", "FN M249 Para", 24000, "18", "HIGH", "Heavy"}
	tempWeaponsArray[124] = {"models/weapons/arccw/c_mw3e_qbz97.mdl", "arccw_mw3e_qbz97", "QBZ-97", 15000, "11", "MID", "Rifle"}
	tempWeaponsArray[125] = {"models/viper/mw/weapons/p320_arccw.mdl", "arccw_mw_p320", "SIG P320 RX", 4000, "1", "LOW", "Pistol"}
	tempWeaponsArray[126] = {"models/weapons/arccw/c_mw3e_mp9.mdl", "arccw_mw3e_mp9", "B&T MP9", 11550, "6", "LOW", "SMG"}
	tempWeaponsArray[127] = {"models/weapons/arccw/c_mw2e_pp2000.mdl", "arccw_mw2e_pp2000", "PP-2000", 9995, "5", "LOW", "Pistol"}
	tempWeaponsArray[128] = {"models/weapons/arccw/c_mw3e_pp90m1.mdl", "arccw_mw3e_pp90m1", "PP-90M1", 10900, "6", "LOW", "SMG"}
	tempWeaponsArray[129] = {"models/weapons/arccw/c_mw3e_acr.mdl", "arccw_mw3e_acr", "Remington ACR", 17000, "13", "MID", "Rifle"}
	tempWeaponsArray[130] = {"models/weapons/arccw/c_bo1_crossbow.mdl", "arccw_bo1_crossbow", "Crossbow", 20000, "12", "MID", "Heavy"}
	tempWeaponsArray[131] = {"models/weapons/arccw/c_cod4_r700.mdl", "arccw_cod4e_r700", "Remington 700", 14995, "13", "MID", "Sniper"}
